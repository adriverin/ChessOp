        ...
        <div className="flex flex-col h-full bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div className="flex-1 p-4 overflow-y-auto">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <button className="text-xs text-emerald-600 dark:text-emerald-400 hover:underline flex items-center gap-1" type="button">
                        <EyeIcon />
                        Reveal All
                    </button>
                </div>
                ...
                <div className="space-y-2">
                    {parsedMoves.slice(0, movesPlayed.length).map((move, index) => (
                        <div
                            key={index}
