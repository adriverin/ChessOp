...
export function ModePicker({
    ...
    return (
        <div className="w-full max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
                ...
                <div className="mt-6 flex items-center justify-center gap-4 flex-wrap">
                    <StatChip
                        ...
                        variant={userStats.currentStreak >= 7 ? 'success' : 'default'}
                    />
                    <StatChip
                        icon={<ClockIcon />}
                        label="Due Reviews"
                        value={userStats.dueReviews}
                        variant={userStats.dueReviews > 0 ? 'warning' : 'default'}
                    />
                    <StatChip
                        icon={<BatteryIcon />}
                        label="Stamina"
                    ...
                    <StatChip
                        ...
                        variant={averageMastery >= 80 ? 'success' : 'default'}
                    />
                </div>
            </div>
            ...
            {/* Guest Banner */}
            {isGuest && (
                <div className="mb-8 p-4 rounded-xl bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 border border-amber-200 dark:border-amber-700/50">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-amber-400 dark:bg-amber-500 flex items-center justify-center flex-shrink-0">
