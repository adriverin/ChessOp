...
export function QuickStartPanel({
    ...
    return (
        <section className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
            <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(135deg,rgba(16,185,129,0.10),transparent_45%),linear-gradient(315deg,rgba(245,158,11,0.12),transparent_55%)] dark:bg-[linear-gradient(135deg,rgba(16,185,129,0.14),transparent_45%),linear-gradient(315deg,rgba(245,158,11,0.16),transparent_55%)]" />
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                    <div>
                        ...
                        <select
                            ...
                            className="mt-2 w-full rounded-xl bg-white dark:bg-slate-950/40 px-3 py-2.5 text-sm text-slate-900 dark:text-white ring-1 ring-inset ring-slate-200 dark:ring-slate-800 hover:ring-slate-300 dark:hover:ring-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500/60"
                        >
                        ...
                        >
                            ...
                            {filteredVariations.map(v => (
                                <option key={v.id} value={v.id}>
                                    {v.name}{v.isPremium ? ' • Premium' : ''}{v.isLocked ? ' • Locked' : ''}
                                </option>
                            ))}
                        </select>
                    </div>
