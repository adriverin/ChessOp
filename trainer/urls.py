...
urlpatterns = [
    ...
    path('api/mistakes/clear/', views.api_clear_mistakes, name='api_clear_mistakes'),
    path('api/mistakes/', views.api_get_mistakes, name='api_get_mistakes'),
    path('api/mistakes/<int:mistake_id>/', views.api_delete_mistake, name='api_delete_mistake'),
