    ...
    def handle(self, *args, **kwargs):
        ...
        data = {
            ...
            "1.d4 — Queen’s Pawn Openings": [
                ...
                { "id": "qid", "name": "Queen’s Indian", "tags": "Black, Indian", "variations": qidVariations },
                { "id": "kid", "name": "King’s Indian", "tags": "Black, Indian", "variations": kidVariations },
                { "id": "grunfeld", "name": "Grünfeld Defense", "tags": "Black, Indian", "variations": grunfeldVariations },
        ...
        for cat_name, openings in data.items():
            category = OpeningCategory.objects.create(name=cat_name)
            for op in openings:
        ...
        self.stdout.write(self.style.SUCCESS('Successfully loaded all chess data'))
